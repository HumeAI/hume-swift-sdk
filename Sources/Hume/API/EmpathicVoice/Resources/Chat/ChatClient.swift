...
public class Chat: NSObject {
  ...
  public func connect(
    with chatConnectOptions: ChatConnectOptions? = nil,
  ...
  @available(*, deprecated, message: "Use connect(with:onOpen:onClose:onError:) instead")
  public func connect(
    configId: String? = nil,
    ...
    return try await connect(with: options, onOpen: onOpen, onClose: onClose, onError: onError)
  }
}
