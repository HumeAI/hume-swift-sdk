...
//  Hume
//
//  Created by Chris on 8/12/25.
//

import AVFoundation

final class RawAudioPlayer: Sendable {
  var meteredSourceNode: MeteredAudioSourceNode!
  ...
  init(format: AVAudioFormat) {
    self.format = format
    meteredSourceNode = MeteredAudioSourceNode(format: format, renderBlock: supplyAudioData)
  }
